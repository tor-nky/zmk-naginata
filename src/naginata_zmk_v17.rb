...
r_kogaki  = %w(xya xyu xyo xa xi lu xe lo lwa ltu xke xka)
...
r_kumiawase << %w(tya chu cho dya dyu dyo)
...
r_gairai << %w(qa qi qe qo kulwa gwa gwi gwe gwo gulwa)
